...
class Solution {
    ...
    Node copyList(Node head) {
        ...
        while (curr != null) {
            ...
            newNode.next = curr.next;            // Link the new node's next to current node's next
        ...
        while (curr != null) {
            ...
            if (copy.next != null) {
                copy.next = copy.next.next;  // Set next of copied nodes
            }
            curr = curr.next;  // Move to the next original node
            copy = copy.next;  // Move to the next copied node
        }

        return copiedHead;  // Return the head of the cloned list
    }
}
